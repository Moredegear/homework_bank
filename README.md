...
* Также есть функции считования информации из csv и exel файлв в модуле reading
*  Функция,search_string принимает список словарей с данными о банковских операциях и строку поиска, а возвращает список словарей, у которых в описании есть данная строка.
...
* Функция main это функция общения с пользователем он же и соединяет остальные функции в единую программу 
## Тестирование:
